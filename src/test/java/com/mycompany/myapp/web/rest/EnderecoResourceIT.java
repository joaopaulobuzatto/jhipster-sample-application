...
class EnderecoResourceIT {
    ...
    void createEndereco() throws Exception {
        ...
        assertThat(testEndereco.getPontoReferencia()).isEqualTo(DEFAULT_PONTO_REFERENCIA);
    ...
    void putExistingEndereco() throws Exception {
        ...
        assertThat(testEndereco.getPontoReferencia()).isEqualTo(UPDATED_PONTO_REFERENCIA);
