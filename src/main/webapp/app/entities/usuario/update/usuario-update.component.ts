...
export class UsuarioUpdateComponent implements OnInit {
  ...
  protected loadRelationshipsOptions(): void {
    this.licencaService
      ...
      .pipe(map((licencas: ILicenca[]) => this.licencaService.addLicencaToCollectionIfMissing<ILicenca>(licencas, this.usuario?.licenca)))
    ...
    this.usuarioService
      ...
      .pipe(
        map((usuarios: IUsuario[]) =>
          this.usuarioService.addUsuarioToCollectionIfMissing<IUsuario>(usuarios, this.usuario?.supervisor, this.usuario?.usuarioCriador)
        )
      )
    ...
    this.pessoaFisicaService
      ...
      .pipe(
        map((pessoaFisicas: IPessoaFisica[]) =>
          this.pessoaFisicaService.addPessoaFisicaToCollectionIfMissing<IPessoaFisica>(pessoaFisicas, this.usuario?.pessoaFisica)
        )
      )
