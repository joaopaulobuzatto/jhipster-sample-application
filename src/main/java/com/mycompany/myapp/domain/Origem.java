...
public class Origem implements Serializable {
    ...
    public Origem codigo(Long codigo) {
    ...
    public Origem dataCriacao(Instant dataCriacao) {
    ...
    public Origem descricao(String descricao) {
    ...
    public Origem tipo(TipoOrigem tipo) {
        this.setTipo(tipo);
        return this;
    }
    ...
    public Origem licenca(Licenca licenca) {
    ...
    public Origem usuarioCriador(Usuario usuario) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Origem)) {
            return false;
        }
        return id != null && id.equals(((Origem) o).id);
    }
