...
public class HorarioTrabalho implements Serializable {
    ...
    public HorarioTrabalho id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public HorarioTrabalho codigo(Long codigo) {
    ...
    public HorarioTrabalho dataCriacao(Instant dataCriacao) {
    ...
    public HorarioTrabalho descricao(String descricao) {
    ...
    public HorarioTrabalho licenca(Licenca licenca) {
    ...
    public HorarioTrabalho usuarioCriador(Usuario usuario) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof HorarioTrabalho)) {
            return false;
        }
        return id != null && id.equals(((HorarioTrabalho) o).id);
    }
