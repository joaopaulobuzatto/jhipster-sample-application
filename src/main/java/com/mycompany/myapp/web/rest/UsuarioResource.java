        ...
        Optional<Usuario> result = usuarioRepository
            ...
            .map(existingUsuario -> {
                ...
                if (usuario.getIsAdmin() != null) {
                    existingUsuario.setIsAdmin(usuario.getIsAdmin());
                }
                if (usuario.getIsSuporte() != null) {
                    existingUsuario.setIsSuporte(usuario.getIsSuporte());
                }
                if (usuario.getNomeExibicao() != null) {
                    existingUsuario.setNomeExibicao(usuario.getNomeExibicao());
                }
                if (usuario.getIsConsultor() != null) {
                    existingUsuario.setIsConsultor(usuario.getIsConsultor());
                }
                if (usuario.getIsSupervisor() != null) {
                    existingUsuario.setIsSupervisor(usuario.getIsSupervisor());
                }
                if (usuario.getIsAtivo() != null) {
                    existingUsuario.setIsAtivo(usuario.getIsAtivo());
                }
                if (usuario.getIsAdministrativo() != null) {
                    existingUsuario.setIsAdministrativo(usuario.getIsAdministrativo());
                }
                if (usuario.getReceberEmails() != null) {
                    existingUsuario.setReceberEmails(usuario.getReceberEmails());
                }
                if (usuario.getIsEmailValido() != null) {
                    existingUsuario.setIsEmailValido(usuario.getIsEmailValido());
                }
                if (usuario.getUuidEmail() != null) {
                    existingUsuario.setUuidEmail(usuario.getUuidEmail());
                }
                if (usuario.getEmail() != null) {
                    existingUsuario.setEmail(usuario.getEmail());
                }
                if (usuario.getIsExecutorSac() != null) {
                    existingUsuario.setIsExecutorSac(usuario.getIsExecutorSac());
                }
                if (usuario.getLiberarHorarioFeriado() != null) {
                    existingUsuario.setLiberarHorarioFeriado(usuario.getLiberarHorarioFeriado());
                }
