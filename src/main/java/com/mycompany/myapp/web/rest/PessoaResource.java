...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Pessoa}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PessoaResource {
    ...
    public ResponseEntity<Pessoa> partialUpdatePessoa(
        ...
        Optional<Pessoa> result = pessoaRepository
            ...
            .map(existingPessoa -> {
                if (pessoa.getEmail1() != null) {
                    existingPessoa.setEmail1(pessoa.getEmail1());
                }
                if (pessoa.getTelefone1() != null) {
                    existingPessoa.setTelefone1(pessoa.getTelefone1());
                }
